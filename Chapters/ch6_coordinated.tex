...
\begin{figure}
    ...
    \caption[Histogram of poloidal magnetic ﬂux per unit length from the coordinated analysis]{Histograms of the local maximum magnetic flux, $|A_m|$, of events identified via GS analysis during the coordinated orbit intervals. Blue (red) lines indicate solar wind (magnetosheath) events. The dashed (solid) lines represent events with negative (positive) $A_m$.}
